...
public class ServicioUjaCovid {
    ...
    public Rastreador altaRastreador(@NotNull @Valid Rastreador rastreador) {
     ...
     /**
     * Notificar el postivo de un usuario
     * @param id del usuario que ha dado positivo
     * @param fechaPositivo fecha cuando el usuario dió positivo 
     * @param rastreador el rastreador que reporta ese positivo
     */
    ...
    /**
     * Notificar el curado de un usuario
     * @param id del usuario que ha dado positivo
     */
    ...
    public void notificarCurado(String id) {
     ...
     /**
     * Notificar un contacto de un usuario positivo
     * @param id del usuario que ha dado positivo
     * @param contactos lista de los contactos de ese positivo, inicialmente vacía
     */
    ...
    public void notificarContacto(String id, ArrayList<Contacto> contactos) {
     ...
     /**
     * Listar los contactos de un positivo
     * @param id del usuario que ha dado positivo
     */
    ...
    public ArrayList<String> ListarContactos(String id) {
     ...
     /**
     * Calcular todos los positivos en los 15 últimos dias
     */
    ...
    public int CalcularPositivos() {
     ...
     /**
     * Calcular la media de contactos por positivos
     */
